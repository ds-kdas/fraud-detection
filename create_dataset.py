...
s3_client.download_file(
    Bucket=args.bucket_name, Key=result_key, Filename="/opt/ml/processing/result.pkl"
)
dataset = pd.read_pickle("/opt/ml/processing/result.pkl")
...
train.to_pickle(train_output_path / "train.pkl", index=False)
test.to_pickle(test_output_path / "test.pkl", index=False)